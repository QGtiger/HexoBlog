...
>首先这里使用的是layui框架的[选项卡组件](https://www.layui.com/demo/tab.html)，在相关的html模板文件添加
...
>这里就是简单的处理数据并返回数据构成前端页面，这里的话，可能关系到models文件的数据库对象，这里也是不展示了，你可以去我的githup上git clone下来看看。[地址](https://github.com/QGtiger/LightBlog)
